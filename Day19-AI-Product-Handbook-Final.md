...
| **AI đọc hợp đồng lao động** *(sản phẩm Day 16–17)* | **Manage Closely** — rủi ro cao về định nghĩa "tư vấn pháp lý" | **Keep Satisfied** — ký sinh Claude Sonnet làm core |
...
> **Với sản phẩm đọc hợp đồng (Day 16–17):** Lý do #2 (Trust deficit) là rào cản lớn nhất — người dùng phải tin rằng file HĐ nhạy cảm của họ không bị lưu, không bị leak. Thiết kế privacy-first từ ngày đầu không phải nice-to-have.
...
#### Mapping ADKAR vào sản phẩm Day 16–17

| Bước | Điểm nghẽn thực tế | Giải pháp cụ thể |
|---|---|---|
| Awareness | Tech worker không biết tool này tồn tại | Partnership nhúng vào ITviec/TopDev ngay trang offer |
| **Desire** ← **Điểm yếu nhất** | "Tôi có thể hỏi ChatGPT miễn phí mà" | Story: "Bạn biết mình đang từ bỏ quyền gì trước khi ký không?" |
| Knowledge | Không chắc AI hiểu đúng luật VN | Demo ngắn 60 giây với 1 điều khoản IP thật |
| Ability | Onboarding phức tạp (đăng ký, chọn plan) | Upload thẳng trên landing page — không cần account |
| Reinforcement | Dùng 1 lần khi nhận offer, không có lý do dùng lại | Trigger: khi chuyển việc lần 2; Referral cho đồng nghiệp |
...
2. **Human-in-the-loop:** "AI *không* tự động kết luận điều khoản vi phạm pháp luật. Nó flag và giải thích — bạn quyết định hành động."
3. **Privacy concrete:**
   - "File HĐ của bạn *không được lưu* sau khi session kết thúc"
   - "Data *không* được dùng để train model"
   - "Bạn có thể xóa toàn bộ lịch sử bất kỳ lúc nào"
...
| **Nhân vật điển hình** | Developer vừa nhận offer 2 ngày trước deadline ký |
...
Áp dụng vào sản phẩm Day 16–17:
- User paste trực tiếp 1 đoạn điều khoản IP trên landing page (không cần sign up)
- Trong 10 giây thấy giải thích: "Điều này có nghĩa là tất cả side project bạn làm ngoài giờ đều thuộc sở hữu công ty"
- "Aha! Tôi cần đọc kỹ hơn!" — *Lúc đó* mới prompt upload full file
...
| | |
|---|---|
| **Câu nói** | "Nếu tôi hỏi AI về hợp đồng, sếp mới biết tôi không hiểu gì — xấu hổ lắm" |
| **Tắc ở** | Identity |
| **Chỗ thua trong ADKAR** | Desire (sợ hơn muốn) |
| **Nhân vật điển hình** | Fresher nhận offer đầu tiên — muốn tỏ ra "chuyên nghiệp" |

**Thuốc giải — Superpower Narrative:**

❌ **BAD:** "Phát hiện vi phạm pháp luật trong hợp đồng của bạn"
> → Fresher đọc xong → "Nếu tôi phát hiện vi phạm mà đã ký rồi thì làm sao? Sếp mới ghét tôi"

✅ **GOOD:** "AI làm bạn trở thành người ký hợp đồng thông minh nhất team"

**Reframe:** Không phải "AI phát hiện vấn đề" — mà *"Bạn là người chủ động review, negotiate như senior"*.

**Tagline mẫu:**
- "Negotiate như Senior Engineer — dù mới đi làm."
- "Biết mình ký gì — trước khi ký."
- "AI là luật sư riêng của bạn. Bạn là người ra quyết định."

**Identity shift:** từ "fresher không hiểu gì về pháp lý" → "người duy nhất trong team đã đọc kỹ hợp đồng".
...
|---|---|
| **The Skeptic** | "90% tech worker Việt Nam ký hợp đồng nước ngoài mà không biết điều khoản IP assignment ràng buộc side project cá nhân. Dữ liệu thực tế từ 200 case — đây là lý do bọn em build khác." |
| **The Overloaded** | "Bạn có 48 tiếng để quyết định ký hay không. Bọn em giúp bạn hiểu toàn bộ điều khoản rủi ro trong 10 phút — và tôi sẽ chứng minh trong 30 giây." |
| **The Fearful** | "Anh Tuấn, senior developer tại công ty Singapore, đã dùng tool này trước khi ký. Anh đó negotiate được carve-out cho side project cá nhân — điều mà HR ban đầu nói không thể. Đây là cách anh làm." |
...
❌ "Hiểu rõ hợp đồng của bạn" — không ai tin
✅ "Biết trong 10 phút điều khoản IP nào ràng buộc side project của bạn" — believable
...
#### Ví dụ — Sản phẩm đọc hợp đồng lao động (Day 16–17)

**S:** "Mỗi năm, hàng trăm nghìn tech worker Việt Nam nhận offer từ công ty nước ngoài — số lượng tăng mạnh sau 2022 theo dữ liệu tuyển dụng ITviec."

**C:** "Nhưng 90% trong số họ phải ký hợp đồng tiếng Anh có điều khoản IP assignment, non-compete, và ESOP phức tạp — trong 2–5 ngày ra quyết định — mà không có ai giải thích điều khoản đó ảnh hưởng đến họ thế nào."

**Q:** "Làm sao hiểu rõ mình đang ký gì và có thể negotiate điều khoản nào — trong vòng 10 phút — trước khi deadline qua đi?"

**A:** "ContractAI — chatbot AI đọc và giải thích hợp đồng lao động nước ngoài theo luật lao động Việt Nam, flag điều khoản rủi ro bằng tiếng Việt thường ngày. Pilot Wizard of Oz: 15 user, 13/15 hiểu rõ điều khoản cần hỏi lại HR trước khi ký. Đang gọi 300M VND seed để build AI version trong 8 tuần."

**Total:** 4 câu — 45 giây pitch. Đủ để VC quyết định.
...
#### Filled example — ContractAI (sản phẩm Day 16–17)

> Bọn em là **ContractAI**. Bọn em giúp **fresher và mid-level tech worker VN** giải quyết việc **ký hợp đồng nước ngoài mà không hiểu điều khoản IP/non-compete trong 2–5 ngày deadline** bằng **AI đọc HĐ và flag rủi ro theo luật lao động Việt Nam, không cần sign up**. Pilot 15 user: 87% hiểu rõ điều khoản cần negotiate. Copy-to-action rate 53%. Gọi 300M VND seed để build AI version và mở rộng lên 200 user trong 8 tuần.
...
**Với ContractAI (Day 16–17):** Ở giai đoạn hiện tại (Wizard of Oz MVP, 15 user), **chọn Seed VC** — pitch vision và founder-market fit. Chưa đủ MRR để pitch Series A.
...
#### Ví dụ điền sẵn — ContractAI

```
PITCH MEMO — ContractAI

1. THE PROBLEM
Mỗi năm, hàng trăm nghìn tech worker VN nhận offer từ công ty nước ngoài
và phải ký hợp đồng tiếng Anh có điều khoản IP assignment, non-compete,
ESOP phức tạp — trong 2–5 ngày — mà không có ai giải thích rủi ro cụ thể.
Luật sư: 200k–500k/giờ + chờ 2–3 ngày. ChatGPT: không có knowledge base
pháp lý VN và không embed vào đúng khoảnh khắc ra quyết định.

2. THE INSIGHT
Tech worker VN không cần "tư vấn pháp lý" — họ cần "đủ thông tin để biết
câu nào cần hỏi lại HR". Đây là gap mà cả luật sư lẫn ChatGPT đều không
lấp được vì: một bên quá chậm và đắt, một bên quá chung chung.

3. THE SOLUTION
ContractAI là chatbot AI đọc file hợp đồng lao động do người dùng upload
(PDF/Word, tiếng Anh hoặc song ngữ), phân tích theo BLLĐ 2019 + pattern
điều khoản phổ biến từ HĐ công ty nước ngoài tại VN, và trả về danh sách
điều khoản rủi ro được giải thích bằng tiếng Việt thường ngày — trong 5
phút, không cần sign up, không lưu file sau session. Differentiator: embed
trực tiếp vào ITviec/TopDev ngay trang offer (distribution moat) + domain
data flywheel từ 5.000+ HĐ được review (data moat).

4. WHY NOW
Sau 2022–2023, số công ty nước ngoài tuyển trực tiếp tại VN tăng mạnh
(theo báo cáo ITviec). Đồng thời, LLM đã đủ khả năng xử lý văn bản pháp
lý song ngữ với chi phí API ~2k–5k VNĐ/HĐ — đủ margin để sustainable
ngay từ user đầu tiên.

5. TRACTION / PROOF
- Wizard of Oz MVP (15 user): 87% (13/15) hiểu rõ điều khoản cần hỏi lại
  HR sau khi nhận kết quả. Copy-to-action rate: 53% (ngưỡng success: 40%).
- 3 user đã negotiate được carve-out IP cho side project cá nhân.
- Return rate D30: đang đo (dự kiến sau 6 tuần đủ 200 user).
- Unit economics: API cost ~3k VNĐ/HĐ; giá 99k–149k/lần → gross margin 97%.

6. THE ASK
Gọi 300M VND seed để: (1) Build AI version trong 8 tuần (thay Wizard of Oz),
(2) Reach 200 paying user trong 3 tháng, (3) Validate partnership với ITviec.
Target Seed VC: ThinkZone, Do Ventures, hoặc Antler Vietnam.
```
...
Quay lại reflection ở Block 1 (mini-checkpoint). Audience nào bạn đang target?
...
> **Với ContractAI (Day 16–17):** Chọn Seed VC — ThinkZone Ventures hoặc Antler Vietnam. Cả hai đã invest B2B SaaS và legal tech tại Đông Nam Á. Phù hợp với giai đoạn Wizard of Oz hiện tại.
...
- ❌ "Đang test với một vài người quen biết"
...
- Tech jargon (RAG, vector DB, BLLĐ 2019...) → bỏ
...
> **Với ContractAI (Day 16–17):** Moat mạnh nhất là Distribution moat (nhúng vào ITviec/TopDev đúng khoảnh khắc nhận offer) + Domain data moat (5.000+ HĐ công ty nước ngoài tại VN — pattern mà OpenAI không có trong training data). ChatGPT review HĐ được — nhưng không embed vào đúng kênh và không có knowledge base BLLĐ 2019 được cấu trúc hóa theo context VN.
...
- Không có plan B nếu Anthropic đổi pricing API
- Community mơ hồ ("người dùng tiềm năng")

> **Gợi ý cho ContractAI:** Lead VC → ThinkZone Ventures (đã invest LegalTech tại SEA). Foundation Model → Claude Sonnet primary; fallback GPT-4o nếu Anthropic đổi pricing (đã ghi rõ trong Day 17 PRD). Community → ITviec forum + Facebook "Cộng đồng Developer Việt Nam" (300k members).
...
**Fail signals:**
- "AI giúp bạn hiểu hợp đồng tốt hơn"
- Không có tên người cụ thể
- Không có con số
- Generic — bất kỳ AI startup nào cũng dùng được

> **Gợi ý hook cho ContractAI — The Overloaded:**
> "Bạn có 48 tiếng để ký hay không ký. Bọn em giúp bạn hiểu rõ điều khoản IP trong 10 phút — không cần đăng ký."
...
- Tech jargon từ câu đầu (RAG, BLLĐ, vector DB)
...
- ✓ Differentiator có concrete metric (vd: "10 phút review" không phải "AI tiên tiến")
- ✓ Pain quantified (vd: "2–5 ngày deadline" không phải "áp lực thời gian")
...
- **Đừng dùng tech jargon** (RAG, vector DB, BLLĐ 2019, PyMuPDF) ở câu đầu. VC không quan tâm.
- **Đừng pitch features.** Pitch outcomes. "Đọc file HĐ và flag điều khoản" là feature. "Biết mình ký gì trước khi ký" là outcome.
...
9. **Do Ventures — Vietnam Startup Ecosystem**
   https://doventures.vc
   Quỹ tier-1 tại Việt Nam — research trước khi pitch.

10. **ThinkZone Ventures**
    https://thinkzone.vn
    Portfolio và investment thesis — chuẩn bị tailored pitch.
...
| "Tech worker VN không cần 'tư vấn pháp lý' — họ cần 'đủ thông tin để biết câu nào cần hỏi HR'." *(ContractAI insight)* |
